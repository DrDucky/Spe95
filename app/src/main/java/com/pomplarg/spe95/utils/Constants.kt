...
class Constants {
    companion object {
        ...
        const val CYNO_DOG_ULCO = "Ulco"

        const val SD_LSPCC = "LSPCC / Main courante"
        const val SD_LSPCC44 = "LSPCC 44"
        const val SD_LSPCC46 = "LSPCC 46"
        const val SD_LSPCC221 = "LSPCC 221"
        const val SD_LSPCC224 = "LSPCC 224"
        const val SD_LSPCCLMC1 = "LMC 1"
        const val SD_LSPCCLMC2 = "LMC 2"
        const val SD_KIT_TYROLIENNE = "Kit Tyrolienne"
        const val SD_KIT_TELEPHERIQUE = "Kit Telepherique"

        const val SD_ECH_COULISSE = "Echelle à coulisse"
        const val SD_TELESTEP = "Telestep"
        const val SD_GR_ELEC_21 = "Groupe 21"
        const val SD_GR_ELEC_22 = "Groupe 22"
        const val SD_GR_ELEC_31 = "Groupe 31"
        const val SD_GR_ELEC_32 = "Groupe 32"
        const val SD_GR_ELEC_51 = "Groupe 51"
        const val SD_ECL_SOLARIS = "Solaris"
        const val SD_ECL_NEON = "Néon"
        const val SD_ECL_LUMAPHORE = "Lumaphore"
        const val SD_ECL_BABY = "Baby"
        const val SD_ECL_BABY1 = "Baby 1"
        const val SD_ECL_BABY2 = "Baby 2"
        ...
        const val SD_EXPLO_ASB6 = "ASB6"
        const val SD_EXPLO_ASB8 = "ASB8"
        const val SD_EXPLO_ASB9 = "ASB9"
