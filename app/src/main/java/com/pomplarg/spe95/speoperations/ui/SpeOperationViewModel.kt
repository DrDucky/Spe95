...
class SpeOperationViewModel(
    ...
    fun addOperationIntoFirestore() {
        ...
        if (specialtyDocument == Constants.FIRESTORE_SD_DOCUMENT) {
            ...
            if (_equipementSdEtaiementEtaiMetalPetit.value == true) listOfMaterialsSd.add(MaterialSd(Constants.SD_ETAIEMENT_METAL_PETIT))
            if (_equipementSdEtaiementEtaiMetalMoyen.value == true) listOfMaterialsSd.add(MaterialSd(Constants.SD_ETAIEMENT_METAL_MOYEN))
            if (_equipementSdEtaiementEtaiMetalGrand.value == true) listOfMaterialsSd.add(MaterialSd(Constants.SD_ETAIEMENT_METAL_GRAND))
            ...
            if (_equipementSdPetitMatCarburantSP95.value == true) listOfMaterialsSd.add(MaterialSd(Constants.SD_PETIT_MAT_CARBURANT_SP95))
            if (_equipementSdPetitMatCarburantMarline.value == true) listOfMaterialsSd.add(MaterialSd(Constants.SD_PETIT_MAT_CARBURANT_MARLINE))
            if (_equipementSdPetitMatCarburantMelange.value == true) listOfMaterialsSd.add(MaterialSd(Constants.SD_PETIT_MAT_CARBURANT_MELANGE))
